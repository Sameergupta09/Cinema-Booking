				...
				{showtime.showtime ? (
					<>
						...
						<div className="mx-auto mt-4 flex flex-col items-center rounded-lg bg-gradient-to-br from-indigo-100 to-white p-4 text-center drop-shadow-lg">
							<div className="w-full h-80 bg-black rounded-lg shadow-2xl relative overflow-hidden border-8 border-gray-900 perspective-1000">
							{/* Curved Screen Effect */}
							<div className="absolute inset-0 rounded-[40px] border-[12px] border-gray-700 shadow-inner transform rotate-x-15 scale-110 skew-x-3"></div>

							{/* Screen Gradient for Depth */}
							<div className="absolute inset-0 bg-gradient-to-b from-gray-900 to-black opacity-95"></div>

							{/* Subtle Grid Lines for Realistic Display Effect */}
							<div className="absolute inset-0 bg-[radial-gradient(circle,rgba(255,255,255,0.05) 2%,transparent 5%)] opacity-10"></div>

							{/* Light Reflection for Realism */}
							<div className="absolute top-0 left-0 w-full h-16 bg-white opacity-15 blur-xl"></div>

							{/* Slight Horizontal Curve Effect */}
							<div className="absolute inset-0 transform scale-x-105"></div>

							{/* Cinema Content (Placeholder) */}
							<div className="relative z-10 flex justify-center items-center h-full text-center">
								<span className="text-3xl font-bold text-white drop-shadow-lg">🍿 Cinema Screen</span>
							</div>

							{/* Bottom Glow for Immersive Effect */}
							<div className="absolute bottom-0 w-full h-16 bg-gradient-to-t from-black to-transparent opacity-60"></div>

							{/* Left and Right Edge Glow for More Depth */}
							<div className="absolute left-0 top-0 w-1/5 h-full bg-gradient-to-r from-black to-transparent opacity-30"></div>
							<div className="absolute right-0 top-0 w-1/5 h-full bg-gradient-to-l from-black to-transparent opacity-30"></div>
						</div>
